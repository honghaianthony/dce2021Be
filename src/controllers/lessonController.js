...
module.exports = {
  ...
  getAllLessonsComment: async function (req, res) {
    try {
      let lessons = await lessonService.getAllLessonsComment(req);
      return res.status(200).json(lessons);
    } catch (error) {
      return res.status(200).json({
        errCode: -1,
  ...
  getLessonsByIdComment: async function (req, res) {
    try {
      let lessons = await lessonService.getLessonsByIdComment(req.query.id);
      return res.status(200).json(lessons);
    } catch (error) {
      return res.status(200).json({
        errCode: -1,
  ...
  deleteLessonsComment: async function (req, res) {
    try {
      let lessons = await lessonService.deleteLessonsComment(req.query.id);
      return res.status(200).json(lessons);
    } catch (error) {
      return res.status(200).json({
        errCode: -1,
  ...
  getAllLessonsTest: async function (req, res) {
    try {
      let lessons = await lessonService.getAllLessonsTest(req);
      return res.status(200).json(lessons);
    } catch (error) {
      return res.status(200).json({
        errCode: -1,
